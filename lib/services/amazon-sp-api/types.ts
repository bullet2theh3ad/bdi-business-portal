...
export enum AmazonReportType {
  ...
  FBA_INVENTORY = 'GET_FBA_MYI_UNSUPPRESSED_INVENTORY_DATA', // FBA Manage Inventory
  FBA_FULFILLMENT_INVENTORY = 'GET_FBA_FULFILLMENT_CURRENT_INVENTORY_DATA', // Amazon-Fulfilled Inventory (current)
