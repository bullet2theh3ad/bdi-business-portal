-- ============================================================================
-- BULK CATEGORIZE: Karen E Drennan → OpEx, Contract Labor
-- ============================================================================
-- This script categorizes all Karen E Drennan transactions as OpEx, Contract Labor
-- 
-- STEPS:
...
-- ============================================================================
-- STEP 1: PREVIEW - Bills from Karen E Drennan
-- ============================================================================
SELECT 
  'bill' as source_type,
...
WHERE vendor_name ILIKE '%Karen E Drennan%'
ORDER BY bill_date DESC;

-- ============================================================================
-- STEP 2: PREVIEW - Expenses from Karen E Drennan
-- ============================================================================
SELECT 
...
SELECT 
  'TOTAL' as type,
  (SELECT COUNT(*) FROM quickbooks_bills WHERE vendor_name ILIKE '%Karen E Drennan%') +
  (SELECT COUNT(*) FROM quickbooks_expenses WHERE vendor_name ILIKE '%Karen E Drennan%') as count,
  COALESCE((SELECT SUM(total_amount) FROM quickbooks_bills WHERE vendor_name ILIKE '%Karen E Drennan%'), 0) +
  COALESCE((SELECT SUM(total_amount) FROM quickbooks_expenses WHERE vendor_name ILIKE '%Karen E Drennan%'), 0) as total_amount;
...
SELECT 
  ...
  'opex',
  'Contract Labor',
  'Bulk categorized: Karen E Drennan contract labor',
...
WHERE notes LIKE '%Karen E Drennan%'
...
-- ============================================================================
SELECT 
  'Karen E Drennan Categorized' as summary,
