...
export default function AmazonDataPage() {
  ...
  const reportTypes = [
    ...
    // Inventory (7 types)
    { value: 'inventory_fulfilled', label: 'Amazon-Fulfilled Inventory', icon: FileText, description: 'Current FBA inventory (recommended)', category: 'Inventory' },
  ...
  const getReportTypeId = (type: string): string => {
    const mapping: Record<string, string> = {
      ...
      // Inventory
      inventory_fulfilled: 'GET_FBA_FULFILLMENT_CURRENT_INVENTORY_DATA',
  ...
  const noDateRangeReports = [
    'settlement',
    'inventory_fulfilled', 'inventory_manage', 'inventory_aged', 'inventory_all',
  ...
  // Some reports are auto-generated by Amazon and cannot be requested on-demand
  const autoGeneratedReports = ['settlement', 'inventory_fulfilled'];
  const canRequestNewReport = !autoGeneratedReports.includes(reportType);
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Note:</strong> Settlement and Amazon-Fulfilled Inventory reports are auto-generated by Amazon - use "List Available Reports" only.
              Orders, Returns, Reimbursements, Sales, and Catalog reports can be requested with custom date ranges.
              Other Inventory and Fee reports use current data (dates not needed).
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
