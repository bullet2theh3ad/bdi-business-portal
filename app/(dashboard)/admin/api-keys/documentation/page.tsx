    ...
    <div className="flex-1 p-4 lg:p-8 max-w-6xl mx-auto">
      ...
      <Card className="mb-8 border-orange-200 bg-orange-50">
        <CardHeader>
          <CardTitle className="flex items-center text-orange-800">
            ...
            API Key Request Required
          </CardTitle>
          <CardDescription className="text-orange-700">External partners cannot generate API keys themselves</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-lg border border-orange-200">
              <h4 className="font-semibold text-orange-800 mb-2">🔑 To Request API Access:</h4>
              <ol className="space-y-2 text-sm text-orange-700">
                <li><strong>1.</strong> Contact your BDI representative or business development team</li>
                <li><strong>2.</strong> Specify which API permissions you need (Production Files, Forecasts, etc.)</li>
                <li><strong>3.</strong> Provide your organization details and intended use case</li>
                <li><strong>4.</strong> BDI Super Admin will generate and securely share your API key</li>
                <li><strong>5.</strong> Begin integration using the documentation below</li>
              </ol>
            </div>
            
            <div className="text-sm text-orange-600">
              <strong>Contact:</strong> <a href="mailto:api-support@boundlessdevices.com" className="underline">api-support@boundlessdevices.com</a> 
              or <a href="mailto:partnerships@boundlessdevices.com" className="underline">partnerships@boundlessdevices.com</a>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Get started with the BDI Business Portal API (after receiving your API key)</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>
            ...
            <div>
              <h3 className="font-semibold mb-2">3. Example</h3>
              <div className="bg-gray-100 p-3 rounded-md font-mono text-sm">
            ...
            <div>
              <h3 className="font-semibold mb-2">4. Response Format</h3>
