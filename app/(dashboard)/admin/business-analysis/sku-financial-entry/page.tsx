...
import { Calculator, FolderOpen, Edit, Trash2, Search } from 'lucide-react';
                ...
                <CardContent>
                  <div className="space-y-2 text-sm mb-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-gray-900 break-all">{scenario.skuName}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Channel:</span>
                      <span className="font-medium text-gray-800">{scenario.channel}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    {scenario.description && (
                      <div className="mt-2 pt-2 border-t">
                        <p className="text-xs text-gray-500 italic line-clamp-2">{scenario.description}</p>
                      </div>
                    )}
