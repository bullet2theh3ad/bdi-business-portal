    ...
    <div className="container mx-auto p-4 sm:p-6 max-w-[1800px]">
      ...
      {metrics && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card className="border-l-4 border-l-green-500">
            ...
            <CardContent>
              <div className="text-sm font-bold text-green-600 break-words">{formatCurrency(metrics.totalRevenue)}</div>
          ...
          <Card className="border-l-4 border-l-blue-500">
            ...
            <CardContent>
              <div className="text-sm font-bold text-blue-600 break-words">{formatCurrency(metrics.totalAR)}</div>
          ...
          <Card className="border-l-4 border-l-orange-500">
            ...
            <CardContent>
              <div className="text-sm font-bold text-orange-600 break-words">{formatCurrency(metrics.totalExpenses)}</div>
              <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
          ...
          <Card className="border-l-4 border-l-red-500">
            ...
            <CardContent>
              <div className="text-sm font-bold text-red-600 break-words">{metrics.overdueInvoices}</div>
              <p className="text-xs text-gray-500 mt-2">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          {masterMetrics && (
            <>
              {/* Executive KPI Cards - 4 over 4 layout */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Card className="border-l-4 border-l-green-500">
                  ...
                  <CardContent>
                    <div className="text-xs font-bold text-green-600 break-words">{formatCurrency(masterMetrics.summary.netRevenue)}</div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-l-4 border-l-blue-500">
                  ...
                  <CardContent>
                    <div className={`text-xs font-bold break-words ${masterMetrics.summary.netCashFlow >= 0 ? 'text-blue-600' : 'text-red-600'}`}>
                ...
                <Card className="border-l-4 border-l-purple-500">
                  ...
                  <CardContent>
                    <div className={`text-xs font-bold break-words ${masterMetrics.summary.netPosition >= 0 ? 'text-purple-600' : 'text-red-600'}`}>
                ...
                <Card className="border-l-4 border-l-orange-500">
                  ...
                  <CardContent>
                    <div className="text-xs font-bold text-orange-600 break-words">{formatCurrency(masterMetrics.summary.totalAR)}</div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-l-4 border-l-red-500">
                  ...
                  <CardContent>
                    <div className="text-xs font-bold text-red-600 break-words">{formatCurrency(masterMetrics.summary.totalAP)}</div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-l-4 border-l-yellow-500">
                  ...
                  <CardContent>
                    <div className="text-xs font-bold text-yellow-600 break-words">{formatCurrency(masterMetrics.summary.totalOpenPOValue)}</div>
                ...
                <Card className="border-l-4 border-l-pink-500">
                  ...
                  <CardContent>
                    <div className="text-xs font-bold text-pink-600 break-words">{formatCurrency(masterMetrics.summary.totalUnpaidBills)}</div>
                ...
                <Card className="border-l-4 border-l-indigo-500">
                  ...
                  <CardContent>
                    <div className="text-xs font-bold text-indigo-600 break-words">{formatCurrency(masterMetrics.summary.availableCredits)}</div>
                  </CardContent>
                </Card>
              </div>
